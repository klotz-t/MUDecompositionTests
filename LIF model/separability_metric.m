...
%
% Input:    sig = MU source
%           true_firings = spike times from the LIF model
%
% Output:   val = vector of separability metric, false positive and false
%               negative rate, and z-scored value.
%           matched_amps = amplitudes of matched peaks
%           matched_indx = index of matched peaks
%           unmatched_amps = amplitudes of unmatched peaks
%           unmatched_indx = index of unmatched peaks
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
