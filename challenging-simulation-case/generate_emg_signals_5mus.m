...
load('/Users/robinrohlen/Library/CloudStorage/OneDrive-LundUniversity/Dokument/Research/Manus/Benchmark/experimental-simulation/data/S1_20_DF.otb+_decomp.mat_edited.mat')
...
for EMGgrid=1:4
    ...
    for ch=1:64
        ...
        muap{EMGgrid}(ch,:)=muap{EMGgrid}(ch,:)-median(muap{EMGgrid}(ch,:));
...
MUAP{2}=muap_full_grid(1:13,1:5,:);
